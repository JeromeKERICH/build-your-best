    ...
    <div className="bg-white">
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-br from-[#F7E8E8] to-[#F5EFE7]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center items-center mb-8">
            ...
            <p className="text-xl text-[#5A5A5A] font-medium">{result.subtitle}</p>
          </div>
      ...
      <section className="relative py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg text-[#3A3A3A] mb-12">
            <p className="text-xl mb-8">{result.description}</p>
            
            {result.questions && (
              <>
                <p className="font-medium">You're asking big questions like:</p>
                <ul className="mb-8">
                ...
                <p className="italic mb-8">This isn't a crisis. It's an awakening. You're in a sacred season of self-inquiry that will form the foundation of your next chapter.</p>
              </>
            )}

            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-[#F5EFE7] p-6 rounded-lg">
                <h3 className="flex items-center text-xl font-bold text-[#3A3A3A] mb-4">
                  <svg className="w-6 h-6 text-[#B76E79] mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          {/* Resources Section */}
          <div className="bg-[#F5EFE7] rounded-xl p-8 md:p-10 mb-12">
            <h2 className="flex items-center justify-center text-2xl md:text-3xl font-bold text-[#3A3A3A] mb-8">
              <svg className="w-8 h-8 text-[#B76E79] mr-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              {result.resources.map((resource, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-lg font-bold text-[#3A3A3A]">{resource.title}</h3>
                  </div>
                  <p className="text-[#5A5A5A] mb-4">{resource.description}</p>
                  <Link
                    to={resource.link}
                    className="inline-flex items-center text-[#B76E79] font-medium hover:text-[#9E5A63] transition-colors duration-200"
                  >
                    Get started
